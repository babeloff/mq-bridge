...
- [Directory spool](./dir-spool.md) — schemes: `spool://`, `dir-spool://`, `dirspool://`
- [Object Storage (local / cloud)](./object-store.md) — schemes: `local-store://`, `s3://`, `s3a://`, `gs://`, `gcs://`, `az://`, `azure://`, `abfs://`, `abfss://`
