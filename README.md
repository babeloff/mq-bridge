...
planning, analysis and writing, CodeRabbit for reviews and Claude and Copilot 
for bugfixing and additional planning.
...
I didn't use any agent mode to commit code as this usually causes early 
architectural issues that cannot later be resolved easily.
I reviewed all the output code. I cleaned it up manually, 
...
focussing on tests and documentation and try to not add new features for now.
